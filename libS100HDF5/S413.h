...
namespace S100HDF5
{
	LIBS100HDF5_TEMPLATE template class LIBS100HDF5_API std::vector<IrregularGridFeature*>;

	class LIBS100HDF5_API S413 :
		public S100HDF5File
	{
	public:
		S413();
		...
		IrregularGridFeature* GetIrregularGridFeature(std::string featureName);
		int GetIrregularGridFeatureCount();
