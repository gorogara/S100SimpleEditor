...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="FeatureForScale[@primitive='Point']" priority="1">
    <!--<pointInstruction>
      <featureReference>
    ...
    <xsl:call-template name="scaledFeatureTemplate">
      <xsl:with-param name="minScale" select="scaleMinimum"/>
      <xsl:with-param name="maxScale" select="scaleMaximum"/>
