...
function TextPlacement(feature, featurePortrayal, contextParameters)
	if feature.PrimitiveType == PrimitiveType.Point then
		...
		if feature.text then
			featurePortrayal:AddInstructions('LocalOffset:' .. offsetValueX .. ',' .. offsetValueY .. ';TextAlignVertical:Center;TextAlignHorizontal:End;FontSize:10;FontSlant:0;TextInstruction:' .. EncodeString(feature.text) .. ',26,8')
		end
	end
end