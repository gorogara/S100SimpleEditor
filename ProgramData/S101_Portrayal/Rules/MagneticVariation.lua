...
function MagneticVariation(feature, featurePortrayal, contextParameters)
	if feature.PrimitiveType == PrimitiveType.Point then
		...
		featurePortrayal:AddInstructions('LocalOffset:3.51,3.51;FontSize:10;TextInstruction:' .. EncodeString(feature['valueOfMagneticVariation']) .. ',27,8')
	elseif feature.PrimitiveType == PrimitiveType.Curve then
		...
		featurePortrayal:AddInstructions('LocalOffset:3.51,3.51;FontSize:10;TextInstruction:' .. EncodeString(feature.valueOfMagneticVariation, 'varn %3.2f') .. ',27,8')
