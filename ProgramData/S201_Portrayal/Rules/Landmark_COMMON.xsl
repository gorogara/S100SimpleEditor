...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:template match="Landmark[@primitive='Point' and categoryOfLandmark=17 and colour=1]" priority="5">
      <pointInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
   ...
   <xsl:template match="Landmark[@primitive='Point' and categoryOfLandmark=17 and colour=3]" priority="5">
      <pointInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
   ...
   <xsl:template match="Landmark[@primitive='Point' and categoryOfLandmark=17 and colour=6]" priority="5">
      <pointInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
