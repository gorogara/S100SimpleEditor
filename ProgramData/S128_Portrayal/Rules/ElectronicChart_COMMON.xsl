...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:template match="ElectronicChart[@primitive='Surface']" priority="1">
      <lineInstruction>
         <featureReference>
   ...
   <xsl:template match="ElectronicChart[@primitive='Point']" priority="1">
      <textInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
   ...
   <xsl:template match="ElectronicChart[@primitive='Point' and textPlaceCorner=1]" priority="2">
      <textInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
   ...
   <xsl:template match="ElectronicChart[@primitive='Point' and textPlaceCorner=2]" priority="2">
      <textInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
