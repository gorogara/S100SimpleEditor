...
std::unordered_map<std::wstring, std::wstring>& Restriction_Item::GetPermittedValues()
{
...
std::wstring& Restriction_Item::GetPattern()
{
	return pattern;
}
...
std::wstring& Restriction_Item::GetMaxExclusive()
{
	return maxExclusive;
}
...
std::wstring& Restriction_Item::GetValueString()
{
	return valueString;
}
...
int Restriction_Item::GetvalueInteger() 
{
	return valueInteger;
}